...
import dxLookup, { IOptions } from "devextreme/ui/lookup";
import { Component as BaseComponent, IHtmlOptions } from "./core/component";
import NestedOption from "./core/nested-option";
interface ILookupOptions extends IOptions, IHtmlOptions {
...
declare class HideEvent extends NestedOption<{
    delay?: any;
    name?: any;
}> {
    static OptionName: string;
...
declare class ShowEvent extends NestedOption<{
    delay?: any;
    name?: any;
}> {
    static OptionName: string;
...
export { Lookup, ILookupOptions, Animation, At, BoundaryOffset, Collision, DropDownOptions, Hide, HideEvent, Item, My, Offset, Position, Show, ShowEvent, ToolbarItem };
