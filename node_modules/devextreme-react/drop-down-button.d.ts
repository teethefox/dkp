...
interface IDropDownButtonOptions extends IOptions, IHtmlOptions {
    dropDownContentRender?: (props: any) => React.ReactNode;
...
export { DropDownButton, IDropDownButtonOptions, Animation, At, BoundaryOffset, Collision, DropDownOptions, Hide, Item, My, Offset, Position, Show, ToolbarItem };
